/* main.js */
	...
	console.log('\x1b[33m','_______________________________________________________________________');
	console.log("Starting Application...\n\tmain.js\n\tgit: https://github.com/mezcel/electron-container\n", '\x1b[0m');
 ...
 * ------------------------------------------------------------------ */
	...
	io.on('connection', function(socket) {
		...
		socket.on('disconnect', function() {
			console.log('\x1b[4m', '\tDetected a disconnected client user from socketio.\n', '\x1b[0m'); // display updated user array in Node
		});
